...
# 실습5. 세 값으로 설비 종합 상태 판정하기 (도전)

a = int(input("온도를 입력하세요: "))
b = float(input("진동을 입력하세요: "))
c = int(input("전류를 입력하세요: "))
