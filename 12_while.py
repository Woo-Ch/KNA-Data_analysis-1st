...
# 실습1. shile로 목표값 도달까지 반복하기

goal = 7
user_input = 0

while user_input != goal:
  user_input = int(input("정답을 입력하세요: "))
print("정답입니다!")
...
while True: # 조건만 보면 무한반복하는 코드
  user_input2 = int(input("값을 입력하세요. 값의 누적이 15를 넘으면 종료합니다: "))
  input_sum += user_input2 # 누적값 업데이트
...
while user_answer != answer:
  user_answer = int(input("값을 입력해 주세요: "))
  if user_answer > 29:
    print("down")
  elif user_answer < 29:
    print("up")
