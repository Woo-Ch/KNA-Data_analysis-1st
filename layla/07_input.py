...
input("성별: ")
input("나이: ")
# 값을 여러 개 받아야 할 때에는 input을 필요한 수 만큼 작성

# 시도3. 가이드 문구에 규칙과 함께 입력받아야 하는 값들을 출력해준다.
input("이름, 나이를 입력해주세요 (ex. MW, 29): ")
...
# 사용자가 숫자로 입력하여도 컴퓨터는 입력받은 값이 글자로 쓰고싶은 건지 숫자로 쓰고싶은 건지 알 수 없음
# 예) 사용자 입력값이 True인 경우 우연히 True를 입력했는지, bool 타입으로 True를 입력했는지 컴퓨터는 알 수 없음
# 따라서 input으로 입력받은 값은 무조건 str으로 저장

# ====================
# 사용자에게 입력받은 값을 한 번에 출력하기
print("이름: ", name, "나이: ", age) # 이름: MW 나이: 29
...
print("int로 변환한 age 변수의 자료형:", type(age)) # <class 'int'>
...
print("당신의 현재 나이는", 2026 - year + 1, "입니다.")
...
# 사용자 입력값 float으로 변환
tall = float(input("키: "))
print("tall:", tall, "tall의 자료형:", type(tall)) # tall: 12.0 tall의 자료형: <class 'float'>
